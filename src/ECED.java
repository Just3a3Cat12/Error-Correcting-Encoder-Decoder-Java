...
//                binaryEncode.binaryEnco();
                HammingEncodeDecode hammingEncodeDecode = new HammingEncodeDecode(inputFile);
                hammingEncodeDecode.hammingEncode();
                break;
            case "send":
...
//                binaryDecode.biDeco();
                ...
                hammingEncodeDecode1.hammingDecode();
                break;
            default:
                break;
        }
...
class HammingEncodeDecode {
    File file;

    public HammingEncodeDecode(File file) {
        this.file = file;
    }
